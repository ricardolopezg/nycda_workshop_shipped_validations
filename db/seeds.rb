...
job_list = [
  ...
  [9, 6, 60, "Tousled meggings flannel, normcore kale chips seitan venmo lomo selfies drinking vinegar. Selfies green juice franzen, beard letterpress truffaut drinking vinegar gochujang. Try-hard salvia lomo, disrupt meditation hella PBR&B ethical tofu seitan biodiesel. Brooklyn mixtape neutra, freegan twee salvia etsy distillery shoreditch polaroid organic. ", "Zadar", "Budva", 75000.00, "2016-11-00 [00:00:00]", "Hipsters"]
]
